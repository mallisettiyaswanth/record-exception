...
const Analytics = () => {
  const [applicationCountType, setApplicationCountType] =
    React.useState("total");
  const applicationCountTypes = [
    {
      value: "total",
      label: "Total",
    },
...
const DoubleCard = ({ header, count }: { header: string; count: number }) => {
  return (
    <div className="realtive w-44 h-28 flex items-center justify-center">
      <div className="absolute bg-primary/10 rounded-xl h-28 w-40 border-none shadwo-sm" />
      <div className="w-full bg-white h-24 shadow rounded-xl z-10 p-3 border flex flex-col gap-2">
        <h1 className="text-gray-400 font-semibold">{header}</h1>
    ...
    <div className="flex flex-col gap-5">
      <div className="flex items-center gap-2 space-y-0 sm:flex-row">
        ...
        <Select value={timeRange} onValueChange={setTimeRange}>
          <SelectTrigger
            className="w-[160px] rounded-full sm:ml-auto bg-primary text-white"
